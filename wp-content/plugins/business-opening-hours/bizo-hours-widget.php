	...
	public function widget( $args, $instance ) {
		...
		<table class="bizoh-table bizoh-widget">
			...
			<tbody>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 2){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Tuesday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 3){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Wednesday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 4){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Thursday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 5){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Friday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 6){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Saturday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
				...
				<?php } else { ?>
				<tr <?php if($currentday == 0){ echo $bizoh_currentday_style;} ?> style="color:#ff0000"><td><?php _e('Sunday', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td><td><?php _e('Close', 'bizo-hours'); ?></td></tr>
				<?php } ?>
		    </tbody>
		</table>
		<?php
